...
ola_mundo("nome", 123)   # Veja que 123 é um argumento a mais que a função ola_mundo() não espera, mas o decorador @Meu_decorador permite que isso aconteça sem gerar um erro.
